...
cp /home/ec2-user/14.2.roboshop-shell-script/catalogue.service /etc/systemd/system/catalogue.service &>> $LOGFILE
...
cp /home/ec2-user/14.2.roboshop-shell-script/mongo.repo /etc/yum.repos.d/mongo.repo &>> $LOGFILE
